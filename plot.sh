...
#
# t(x) = exp (- x**4 / (2*5*5)) / sqrt(2*pi*5*5)
# binwidth=0.8
# bin(x,w)=w*floor(x/w)
#
...
# set yrange [-20:20]
# plot "output" using 1:2 w lp ls 0 pt 1 t '', \
#      "output" using 1:3 w lp ls 1 pt 1 t '', \
#      "output" using 1:4 w lp ls 2 pt 1 t '', \
#      "output" using 1:5 w lp ls 3 pt 1 t '', \
#      "output" using 1:6 w lp ls 4 pt 1 t '', \
#      "output" using 1:7 w lp ls 5 pt 1 t '', \
#      "output" using 1:8 w lp ls 6 pt 1 t '', \
#      "output" using 1:9 w lp ls 7 pt 1 t '', \
#      "output" using 1:10 w lp ls 8 pt 1 t '', \
#      "output" using 1:11 w lp ls 8 pt 1 t '', \

set offsets 0.1, 0.1, 0.1, 0.00

t(x) = exp (- abs(x)**4) / 1.810
binwidth=0.1
bin(x,w)=w*floor(x/w)
